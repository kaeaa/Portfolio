...
export const NavBody = ({ children, className, visible }) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-transparent px-4 py-2.5 lg:flex",
  ...
  return (
    <motion.div
      animate={{
        ...
        borderRadius: visible ? "2rem" : "0.8rem",
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
